...
import { ID, OAuthProvider } from "appwrite"; // Imported OAuthProvider for better typing/enums
      ...
      <div className="w-full max-w-md space-y-8 bg-white p-10 rounded-xl shadow-lg border border-gray-100">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <button
            ...
            disabled={loading}
            className="flex w-full items-center justify-center gap-2 rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-700 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 transition-all"
          >
          ...
          <button
            ...
            disabled={loading}
            className="flex w-full items-center justify-center gap-2 rounded-md bg-[#0077b5] px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-[#0077b5]/90 transition-all"
          >
          ...
          <button
            ...
            onClick={() => handleOAuth(OAuthProvider.Github)}
            disabled={loading}
            className="flex w-full items-center justify-center gap-2 rounded-md bg-[#24292F] px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-[#24292F]/90 transition-all"
          >
